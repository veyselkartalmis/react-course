...
2-) Provider ---> Consumer Yöntemi
    ...
    -class component oluşturduk ve veriyi state içerisine yerleştirdik
    -Contexte ait Provider ile state'te bulunan veriyi aldık
    -Prent child ilişkisini ekledi {this.props.children}
    -Veriyi göndereceğimiz compenenta Contexti import ediyoruz
